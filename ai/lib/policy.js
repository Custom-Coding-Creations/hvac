 ...
 *
 * This is intentionally rule-based so it works without any LLM.  When an AI
 * provider is configured, its confidence score can feed into this engine via
 * the `confidence` context field.
 */
